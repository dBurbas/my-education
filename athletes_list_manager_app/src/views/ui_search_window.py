...
class Ui_SearchDialog(object):
    def setupUi(self, SearchDialog):
        ...
        self.max_title.setObjectName("max_title")
        ...
        self.title_count_label.setObjectName("title_count_label")
        ...
        self.sport_type.setObjectName("sport_type")
        ...
        self.sport_comboBox.setObjectName("sport_comboBox")
        ...
        self.athlete_category.setObjectName("athlete_category")
        ...
        self.verticalSpacer = QSpacerItem(
            10, 3, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed
        )
        ...
        self.top_space_for_table.setObjectName("top_space_for_table")
        ...
        sizePolicy1.setHeightForWidth(
            self.top_space_for_table.sizePolicy().hasHeightForWidth()
        )
        ...
        icon = QIcon(QIcon.fromTheme("media-seek-backward"))
        ...
        icon1 = QIcon(QIcon.fromTheme("system-reboot"))
        self.prev_pagination_button.setIcon(icon1)
        ...
        self.current_page_button.setSizePolicy(sizePolicy2)
        ...
        icon2 = QIcon(QIcon.fromTheme("media-playback-start"))
        self.next_pagination_button.setIcon(icon2)
        ...
        icon3 = QIcon(QIcon.fromTheme("media-seek-forward"))
    ...
    def retranslateUi(self, SearchDialog):
        SearchDialog.setWindowTitle(
            QCoreApplication.translate("SearchDialog", "Dialog", None)
        )
        self.last_name_label.setText(
            QCoreApplication.translate(
                "SearchDialog", "\u0424\u0430\u043c\u0438\u043b\u0438\u044f", None
            )
        )
        self.first_name_label.setText(
            QCoreApplication.translate("SearchDialog", "\u0418\u043c\u044f", None)
        )
        self.first_name_lineEdit.setText("")
        self.patronymic_label.setText(
            QCoreApplication.translate(
                "SearchDialog", "\u041e\u0442\u0447\u0435\u0441\u0442\u0432\u043e", None
            )
        )
        self.max_label.setText(
            QCoreApplication.translate(
                "SearchDialog", "\u041c\u0430\u043a\u0441\u0438\u043c\u0443\u043c", None
            )
        )
        self.min_label.setText(
            QCoreApplication.translate(
                "SearchDialog", "\u041c\u0438\u043d\u0438\u043c\u0443\u043c", None
            )
        )
        self.title_count_label.setText(
            QCoreApplication.translate(
                "SearchDialog",
                "\u041a\u043e\u043b\u0438\u0447\u0435\u0441\u0442\u0432\u043e \u0442\u0438\u0442\u0443\u043b\u043e\u0432",
                None,
        ...
        self.current_page_button.setText(
            QCoreApplication.translate("SearchDialog", "1", None)
        )
